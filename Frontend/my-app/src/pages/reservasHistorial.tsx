...
import { useReservasGenerales, useModificarCancha, useModificarFechaHora, useEliminarReserva} from '../hooks/useReservas';
                ...
                <ul style={{ listStyle: 'none', padding: 0 }}>
                    {reservas.map((p: any) => (
                        <li key = {p.id_reserva} style={{ marginBottom: '20px', borderBottom: '1px solid #ccc', paddingBottom: '20px' }}>
                            ...
                            <p><strong>Estado:</strong> {p.cancelada ? 'Cancelada' : 'Normal'}</p>
                            ...
                            {modificandoCanchaId === p.id_reserva && (
                                <div style={{ marginTop: '15px', padding: '15px', borderRadius: '5px' }}>
